...
var PythonIDE = {
	...
	showShare: function(){
		...
		$('#share_embed_val').val('<iframe frameborder="0" width="100%" height="400px" src="' + embed + '"><a target="_blank" href="' + link + '">SEANLab Coding</a></iframe>');
	...
	init: function(style) {
		...
		animateTitle('SEANLab Coding', 'title_text');
		...
		if(style == "run") {
			...
			PythonIDE.whenFinished = function() {
				...
				var html = '<div><a class="nounderline" href="http://withcode.uk" target="_blank"><h1 id="title" onmouseover="animateTitle(\'SEANLab Coding\', \'title_text\')"><span class="brackets">{</span><span id="title_text">withcode.uk</span><span class="brackets">}</span></h1></a></div>';
